...
function buildKey(key) {
  if (key.trim().length <= 0) {
    throw new import_SqliteStorageDriverError.SqliteStorageDriverError("build", key, "Key must not be an empty string.");
  }
  return key;
}

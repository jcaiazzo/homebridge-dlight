 ...
 */
const numericTypeByMax = /* @__PURE__ */ new Map([
  [import_general.UINT8_MAX, "uint8"],
  [import_general.UINT16_MAX, "uint16"],
  [import_general.UINT24_MAX, "uint24"],
  [import_general.UINT32_MAX, "uint32"],
  [import_general.UINT64_MAX, "uint64"],
  [import_general.INT8_MAX, "int8"],
  [import_general.INT16_MAX, "int16"],
  [import_general.INT32_MAX, "int32"],
  [import_general.INT64_MAX, "int64"],
  [import_general.FLOAT32_MAX, "single"],
  [import_general.FLOAT64_MAX, "double"]
]);
const boundCache = /* @__PURE__ */ new WeakMap();
class TlvNumericSchema extends import_TlvSchema.TlvSchema {
  ...
  bound({ min, max }) {
    const effectiveMin = (0, import_general.maxValue)(min, this.min);
    const effectiveMax = (0, import_general.minValue)(max, this.max);

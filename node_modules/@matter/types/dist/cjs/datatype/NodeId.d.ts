 ...
 */
import { Branded, Crypto } from "@matter/general";
...
export declare namespace NodeId {
     ...
     */
    const isOperationalNodeId: (nodeId: SubjectId) => nodeId is NodeId;
    ...
    const isCaseAuthenticatedTag: (nodeId: SubjectId) => nodeId is SubjectId;
    const extractAsCaseAuthenticatedTag: (nodeId: SubjectId) => CaseAuthenticatedTag;
    /**

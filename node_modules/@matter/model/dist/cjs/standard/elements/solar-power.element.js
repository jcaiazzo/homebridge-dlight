...
var solar_power_element_exports = {};
__export(solar_power_element_exports, {
  SolarPowerDt: () => SolarPowerDt
});
module.exports = __toCommonJS(solar_power_element_exports);
 ...
 */
const SolarPowerDt = (0, import_elements.DeviceTypeElement)(
  { name: "SolarPower", id: 23, classification: "simple" },
  (0, import_elements.RequirementElement)(
    { name: "Descriptor", id: 29, element: "serverCluster" },
    (0, import_elements.RequirementElement)({ name: "DeviceTypeList", default: [{ deviceType: 23, revision: 1 }], element: "attribute" })
  ),
  ...
  (0, import_elements.RequirementElement)(
    { name: "DeviceEnergyManagement", id: 1293, conformance: "desc", element: "deviceType" },
    (0, import_elements.RequirementElement)(
  ...
  (0, import_elements.RequirementElement)(
    ...
    (0, import_elements.RequirementElement)({ name: "UserLabel", id: 65, conformance: "desc", element: "serverCluster" }),
    (0, import_elements.RequirementElement)(
      { name: "ElectricalPowerMeasurement", id: 144, conformance: "M", element: "serverCluster" },
    ...
    (0, import_elements.RequirementElement)(
      { name: "ElectricalEnergyMeasurement", id: 145, conformance: "M", element: "serverCluster" },
      (0, import_elements.RequirementElement)({ name: "EXPORTEDENERGY", conformance: "M", element: "feature" })
    )
  )
);
import_MatterDefinition.MatterDefinition.children.push(SolarPowerDt);
//# sourceMappingURL=solar-power.element.js.map

...
const DeviceEnergyManagementDt = (0, import_elements.DeviceTypeElement)(
  { name: "DeviceEnergyManagement", id: 1293, classification: "utility" },
  (0, import_elements.RequirementElement)(
    { name: "Descriptor", id: 29, element: "serverCluster" },
    (0, import_elements.RequirementElement)({ name: "DeviceTypeList", default: [{ deviceType: 1293, revision: 3 }], element: "attribute" })
  ),
  (0, import_elements.RequirementElement)(
  ...
  (0, import_elements.RequirementElement)({ name: "ElectricalGridConditions", id: 160, conformance: "O", element: "clientCluster" }),
  (0, import_elements.ConditionElement)({ name: "ControllableEsa" })
);

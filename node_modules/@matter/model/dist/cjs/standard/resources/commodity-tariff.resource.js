...
import_Resource.Resource.add({
  ...
  pics: "SETRF",
  xref: "cluster\xA79.12",
  details: "The CommodityTariffCluster provides the mechanism for communicating Commodity Tariff information within the premises.",
  children: [
    {
      tag: "attribute",
      name: "FeatureMap",
      xref: "cluster\xA79.12.4",
      children: [
    ...
    },
    {
      tag: "attribute",
      name: "TariffInfo",
      xref: "cluster\xA79.12.6.1",
      details: "Indicates basic information about the tariff.\nIf the tariff is unavailable, this attribute shall be null."
    },
    {
      tag: "attribute",
      name: "TariffUnit",
      xref: "cluster\xA79.12.6.2",
      details: "Indicates the unit of the commodity for pricing.\nIf the tariff is unavailable, this attribute shall be null."
    },
    {
      tag: "attribute",
      name: "StartDate",
      xref: "cluster\xA79.12.6.3",
      details: "Indicates a timestamp in UTC to denote the time at which the published calendar becomes active. A start date/time of 0x00000000 shall indicate that the calendar should become active immediately.\nIf the tariff is unavailable, this attribute shall be null."
    },
    {
      tag: "attribute",
      name: "DayEntries",
      xref: "cluster\xA79.12.6.4",
    ...
    },
    {
      ...
      xref: "cluster\xA79.12.6.11",
      details: "Indicates the UTC date when the CurrentDay, CurrentDayEntry, and CurrentTariffComponents attributes were last updated.\nIf the tariff is not active or day entry information is not available, this attribute shall be null."
    },
    {
      tag: "attribute",
      name: "NextDayEntry",
      xref: "cluster\xA79.12.6.12",
    ...
    },
    {
      ...
      xref: "cluster\xA79.12.6.13",
      details: "Indicates the predicted UTC date when the CurrentDay, CurrentDayEntry, and CurrentTariffComponents attributes will update to the values in the NextDay, NextDayEntry, and NextTariffComponents attributes, respectively.\nIf the tariff is not active or is not available, this attribute shall be null."
    },
    {
      tag: "attribute",
      name: "TariffComponents",
      xref: "cluster\xA79.12.6.14",
    ...
    },
    {
      tag: "attribute",
      name: "TariffPeriods",
      xref: "cluster\xA79.12.6.15",
      details: "Indicates a list of TariffPeriodStructs for the tariff.\nIf the tariff is unavailable, this attribute shall be empty."
    },
    {
      tag: "attribute",
      name: "CurrentTariffComponents",
      xref: "cluster\xA79.12.6.16",
      details: "Indicates a list of the currently active TariffComponentStructs.\nIf the tariff is unavailable, this attribute shall be empty."
    },
    {
      tag: "attribute",
      name: "NextTariffComponents",
      xref: "cluster\xA79.12.6.17",
      details: "Indicates the predicted next active TariffComponentStructs.\nIf the tariff is unavailable, this attribute shall be null."
    },
    {
      tag: "attribute",
      name: "DefaultRandomizationOffset",
      xref: "cluster\xA79.12.6.18",
      details: "Indicates a default randomization offset for DayEntryStructs in this tariff. See RandomizationOffset for details."
    },
    {
      tag: "attribute",
      name: "DefaultRandomizationType",
      xref: "cluster\xA79.12.6.19",
      details: "Indicates a default randomization type for DayEntryStruct in this tariff. See RandomizationType for details."
    },
    {
      tag: "command",
      name: "GetTariffComponent",
      xref: "cluster\xA79.12.7.1",
      details: "The GetTariffComponent command allows a client to request information for a tariff component identifier that may no longer be available in the TariffPeriods attributes.",
      children: [{
        tag: "field",
        name: "TariffComponentId",
        xref: "cluster\xA79.12.7.1.1",
    ...
    },
    {
      ...
      xref: "cluster\xA79.12.7.2",
      details: "The GetTariffComponentResponse command is sent in response to a GetTariffComponent command.",
      children: [
        {
          tag: "field",
          name: "Label",
          xref: "cluster\xA79.12.7.2.1",
          details: "A free-form label for the tariff period."
        },
        {
          tag: "field",
          name: "DayEntryIDs",
          xref: "cluster\xA79.12.7.2.2",
          details: "This field shall indicate a list of DayEntryIDs for the DayEntryStructs during which the tariff component is active."
        },
        {
          tag: "field",
          name: "TariffComponent",
          xref: "cluster\xA79.12.7.2.3",
          details: "This field shall indicate the TariffComponentStruct whose TariffComponentID field matches the requested GetTariffComponentTariffComponentID."
        }
      ]
    },
    {
      tag: "command",
      name: "GetDayEntry",
      xref: "cluster\xA79.12.7.3",
      details: "The GetDayEntry command allows a client to request information for a calendar day entry identifier that may no longer be available in the CalendarPeriods or IndividualDays attributes.",
      children: [{
        tag: "field",
        name: "DayEntryId",
        xref: "cluster\xA79.12.7.3.1",
    ...
    {
      tag: "datatype",
      name: "AuxiliaryLoadSettingEnum",
      xref: "cluster\xA79.12.5.2",
    ...
    {
      tag: "datatype",
      name: "PeakPeriodSeverityEnum",
      xref: "cluster\xA79.12.5.4",
      children: [
    ...
    {
      tag: "datatype",
      name: "DayEntryRandomizationTypeEnum",
      xref: "cluster\xA79.12.5.5",
      children: [
    ...
    },
    {
      tag: "datatype",
      name: "BlockModeEnum",
      xref: "cluster\xA79.12.5.6",
      children: [
        {
          tag: "field",
          name: "NoBlock",
          description: "Tariff has no usage blocks",
          xref: "cluster\xA79.12.5.6.1",
          details: "This value shall indicate that the tariff has no usage blocks. All Threshold fields on TariffComponentStruct in a tariff whose BlockMode field is set to NoBlock shall be null."
        },
        {
          tag: "field",
          name: "Combined",
          description: "Usage is metered in combined blocks",
          xref: "cluster\xA79.12.5.6.2",
          details: "This value shall indicate that all Threshold fields apply to combined usage across all TariffComponentStruct during the billing period."
        },
        {
          tag: "field",
          name: "Individual",
          description: "Usage is metered separately by tariff component",
          xref: "cluster\xA79.12.5.6.3",
          details: "This value shall indicate that all Threshold fields apply only to usage during the active period of the associated TariffComponentStruct in the billing period."
        }
      ]
    },
    {
      tag: "datatype",
      name: "AuxiliaryLoadSwitchSettingsStruct",
      xref: "cluster\xA79.12.5.7",
      details: "This represents the settings for a given auxiliary load switch in a tariff component."
    },
    {
      tag: "datatype",
      name: "AuxiliaryLoadSwitchesSettingsStruct",
      xref: "cluster\xA79.12.5.8",
      details: "This represents the set of auxiliary load settings in a tariff component."
    },
    {
      tag: "datatype",
      name: "CalendarPeriodStruct",
      xref: "cluster\xA79.12.5.9",
      details: "This represents a sub period of a calendar, commencing on its StartDate.\n> [!NOTE]\n> NOTE: A 'Calendar Period', while normally considered to be a 3 or 6 month period, could be used for other arbitrary periods e.g. monthly or quarterly. The minimum resolution is 1 day, although a week would normally be the smallest interval.",
      children: [
        {
          tag: "field",
          name: "StartDate",
          xref: "cluster\xA79.12.5.9.1",
    ...
    {
      tag: "datatype",
      name: "TariffPriceStruct",
      xref: "cluster\xA79.12.5.15",
      details: "This indicates a price or price level for a given tariff component, as well as what type of pricing it represents",
      children: [
        {
          tag: "field",
          name: "PriceType",
          xref: "cluster\xA79.12.5.15.1",
          details: "This field shall indicate the type of price for the Price or PriceLevel fields."
        },
        {
          tag: "field",
          name: "Price",
          xref: "cluster\xA79.12.5.15.2",
          details: "This field shall indicate the tariff price."
        },
        {
          tag: "field",
          name: "PriceLevel",
          xref: "cluster\xA79.12.5.15.3",
    ...
    },
    {
      ...
      xref: "cluster\xA79.12.5.17",
      details: "This represents the tariff components in effect for a set of calendar day entry IDs.",
      children: [
        {
          tag: "field",
          name: "Label",
          xref: "cluster\xA79.12.5.17.1",
          details: "A free-form label for the tariff period."
        },
        {
          tag: "field",
          name: "DayEntryIDs",
          xref: "cluster\xA79.12.5.17.2",
          details: "This field shall indicate a list of DayEntryIDs for the DayEntryStructs during which the tariff components are active.\nEach DayEntryID shall be included in at most one DayEntryIDs field. In other words, there shall be only one TariffPeriodStruct for each DayEntryID."
        },
        {
          tag: "field",
          name: "TariffComponentIDs",
          xref: "cluster\xA79.12.5.17.3",
          details: "This field shall indicate a list of TariffComponentIDs for the TariffComponentStructs active during the specified day entries."
        }
      ]
    }
  ]
});
//# sourceMappingURL=commodity-tariff.resource.js.map

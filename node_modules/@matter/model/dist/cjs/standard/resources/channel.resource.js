...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      details: "The Lineup Info allows references to external lineup sources like Gracenote. The combination of OperatorName, LineupName, and PostalCode shall uniquely identify a lineup.",
      children: [
        {
          tag: "field",
          name: "OperatorName",

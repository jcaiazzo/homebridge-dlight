...
import_Resource.Resource.add({
  ...
  pics: "EGC",
  xref: "cluster\xA79.13",
  details: "The Electrical Grid Conditions Cluster provides the mechanism for communicating electricity grid carbon intensity to devices within the premises in units of Grams of CO2e per kWh.\nThis is an important mechanism to allow energy appliances decide when to operate to help consumers reduce their carbon footprint, when the pricing may be the same throughout the day.\nWhen homes have local generation (for example Solar PV) this may mean that the premises at the local grid connection point has effectively no green house gas emissions, and so this cluster allows devices to understand both the grid and local conditions.",
  children: [
    {
      tag: "attribute",
      name: "FeatureMap",
      xref: "cluster\xA79.13.4",
      children: [{
        tag: "field",
        name: "FORE",
        xref: "cluster\xA79.13.4.1",
        details: "The feature indicates the server is capable of providing a forecast of grid and local conditions for several hours in the future."
      }]
    },
    {
      tag: "attribute",
      name: "LocalGenerationAvailable",
      xref: "cluster\xA79.13.6.1",
      details: "This shall indicate if there is known to be local generation (for example Solar PV or Battery Storage) at the premises.\nIf the presence of any local generation is unknown, or cannot be determined, the value shall be null."
    },
    {
      tag: "attribute",
      name: "CurrentConditions",
      xref: "cluster\xA79.13.6.2",
      details: "This shall indicate the current electricity supply conditions. If the current conditions are unknown, or cannot be determined, the value shall be null."
    },
    {
      tag: "attribute",
      name: "ForecastConditions",
      xref: "cluster\xA79.13.6.3",
      details: "This shall indicate the forecast of upcoming electricity supply conditions. If the forecast is unable to be determined, this list shall be empty.\nThe list entries shall be in time order:\n  - All entries except the last one shall have a non-null PeriodEnd.\n  - For all entries except the first one, PeriodStart shall be greater than the previous entry's PeriodEnd."
    },
    {
      tag: "event",
      name: "CurrentConditionsChanged",
      xref: "cluster\xA79.13.7.1",
      details: "This event shall be generated when the value of the CurrentConditions attribute changes.",
      children: [{
        tag: "field",
        name: "CurrentConditions",
        xref: "cluster\xA79.13.7.1.1",

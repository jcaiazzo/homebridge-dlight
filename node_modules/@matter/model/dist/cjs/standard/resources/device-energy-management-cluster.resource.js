...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      details: "Indicates the minimum electrical power that the ESA can consume when switched on. This does not include when in power save or standby modes.\n> [!NOTE]\n> NOTE: For Generator ESAs that can discharge an internal battery (such as a battery storage inverter) to loads in the home, the AbsMinPower will be a negative number representing the maximum power that the ESA can discharge its internal battery."
    },
    {
      tag: "attribute",
      name: "AbsMaxPower",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          details: "This field shall indicate the new requested power that the ESA shall operate at. It shall be between the AbsMinPower and AbsMaxPower attributes as advertised by the ESA if it supports PFR.\nThis is a signed value and can be used to indicate charging or discharging.\nIf the ESA does NOT support PFR this value shall be ignored by the ESA."
        },
        {
          tag: "field",
          name: "Duration",
          xref: "cluster\xA79.2.7.15.3",
          details: "This field shall indicate the new requested duration, in seconds, that the ESA shall extend or shorten the slot duration to. It shall be between the MinDurationAdjustment and MaxDurationAdjustment for the slot as advertised by the ESA."
        }
      ]
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          details: "This field shall indicate the nominal power that client wishes the ESA to operate at during the constrained period. It shall be between the AbsMinPower and AbsMaxPower attributes as advertised by the ESA if it supports PFR.\nThis is a signed value and can be used to indicate charging or discharging."
        },
        {
          tag: "field",
          name: "MaximumEnergy",

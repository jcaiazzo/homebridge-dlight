...
import_Resource.Resource.add({
  ...
  pics: "LVL",
  xref: "cluster\xA71.6",
  details: "This cluster provides an interface for controlling a characteristic of a device that can be set to a level, for example the brightness of a light or lamp, a pump's flow rate setpoint, etc.",
  children: [
    {
      tag: "attribute",
      name: "FeatureMap",
    ...
    },
    {
      ...
      details: "Indicates the minimum value of CurrentLevel that is capable of being assigned.\n> [!NOTE]\n> NOTE: This value is constrained by all lighting device types to 1, and its Conformance is   Mandatory. As such, when the Lighting feature is supported this value shall be 1."
    },
    {
      tag: "attribute",
      name: "MaxLevel",
      xref: "cluster\xA71.6.6.5",
      details: "Indicates the maximum value of CurrentLevel that is capable of being assigned.\n> [!NOTE]\n> NOTE: This value is constrained by all lighting device types to 254, and its Conformance is   Mandatory. As such, when the Lighting feature is supported this value shall be 254."
    },
    {
      tag: "attribute",

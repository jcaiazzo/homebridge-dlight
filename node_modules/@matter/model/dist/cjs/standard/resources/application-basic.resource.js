...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      details: 'This attribute shall specify a human readable (displayable) name of the Content App assigned by the vendor. For example, "NPR On Demand".'
    },
    {
      tag: "attribute",
      name: "ProductId",
    ...
    },
    {
      ...
      details: "This attribute shall specify a human readable (displayable) version of the Content App assigned by the vendor."
    },
    {
      tag: "attribute",
      ...
      children: [
        {
          ...
          details: "This field shall indicate the Connectivity Standards Alliance issued vendor ID for the catalog. The DIAL registry shall use value 0x0000.\nIt is assumed that Content App Platform providers (see Video Player Architecture section in [[MatterDevLib]](#ref_MatterDevLib)) will have their own catalog vendor ID (set to their own Vendor ID) and will assign an ApplicationID to each Content App."
        },
        {
          tag: "field",
          name: "ApplicationId",

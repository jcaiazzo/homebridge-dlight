...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      xref: "core\xA714.5.6.2",
      details: "Indicates a list of currently provisioned TLS Endpoints on this Node. The maximum length of this list when read will be the value of MaxProvisioned."
    },
    {
      tag: "command",
      name: "ProvisionEndpoint",
      xref: "core\xA714.5.7.1",
      details: "This command is used to provision a TLS Endpoint for the provided Hostname / Port combination.",
      children: [
        {
          tag: "field",
          name: "Hostname",
          xref: "core\xA714.5.7.1.1",
          details: "This field shall represent a TLS Hostname."
        },
        {
          tag: "field",
          name: "Port",
          xref: "core\xA714.5.7.1.2",
          details: "This field shall represent a TLS Port Number."
        },
        {
          tag: "field",
          name: "Caid",
          xref: "core\xA714.5.7.1.3",
          details: "This field shall be the TLSCAID used to associate the TLSRCAC with this endpoint."
        },
        {
          tag: "field",
          name: "Ccdid",
          xref: "core\xA714.5.7.1.4",
          details: "This field shall be the TLSCCDID used to associate the Client Certificate Details with this endpoint. A NULL value means no client certificate is associated."
        },
        {
          tag: "field",
          name: "EndpointId",
          xref: "core\xA714.5.7.1.5",
          details: "This field shall represent the unique TLS Endpoint. A NULL value causes a new endpoint to be created and a non-NULL value allows for updating an existing endpoint."
        }
      ]
    },
    {
    ...
    },
    {
      tag: "datatype",
      name: "TLSEndpointID",
      xref: "core\xA714.5.4.1",
      details: "This data type is derived from uint16 and represents a provisioned endpoint with valid values from 0 to 65534. This value SHOULD start at 0 and monotonically increase by 1 with each new allocation provisioned by the Node. A value incremented past 65534 SHOULD wrap to 0. The Node shall verify that a new value does not match any other value for this type. If such a match is found, the value shall be changed until a unique value is found."
    },
    {
      tag: "datatype",
      name: "TLSEndpointStruct",
      xref: "core\xA714.5.4.2",
      details: "This struct encodes details about a TLS Endpoint.",
      children: [
        {
          tag: "field",
          name: "EndpointId",
          xref: "core\xA714.5.4.2.1",
          details: "This field shall represent the unique TLS Endpoint ID."
        },
        {
          tag: "field",
          name: "Hostname",
          xref: "core\xA714.5.4.2.2",
          details: "This field shall represent a TLS Hostname."
        },
        {
          tag: "field",
          name: "Port",
          xref: "core\xA714.5.4.2.3",
          details: "This field shall represent a TLS Port Number."
        },
        {
          tag: "field",
          name: "Caid",
          xref: "core\xA714.5.4.2.4",
          details: "This field shall be a TLSCAID representing the associated Certificate Authority ID."
        },
        {
          tag: "field",
          name: "Ccdid",
          xref: "core\xA714.5.4.2.5",
          details: "This field shall be a TLSCCDID representing the associated Client Certificate Details ID. A NULL value means no client certificate is used with this endpoint."
        },
        {
          tag: "field",
          name: "ReferenceCount",
          xref: "core\xA714.5.4.2.6",
          details: "This field shall indicate a reference count of the number of entities currently using this TLS Endpoint. The node shall recompute this field to reflect the correct value at runtime (e.g., when restored from a persisted value after a reboot)."
        }
      ]
    },
    {
...
//# sourceMappingURL=tls-client-management.resource.js.map

...
class MatterModel extends import_ScopeModel.ScopeModel {
   ...
   */
  get clusters() {
    return this.scope.membersOf(this, { tags: [import_ElementTag.ElementTag.Cluster] });
  }
  /**
   * Device types.
   */
  get deviceTypes() {
    return this.scope.membersOf(this, { tags: [import_ElementTag.ElementTag.DeviceType] });
  }
  /**
   ...
   */
  get datatypes() {
    return this.scope.membersOf(this, { tags: [import_ElementTag.ElementTag.Datatype] });
  }
  /**
   * Global fields.
   */
  get fields() {
    return this.scope.membersOf(this, { tags: [import_ElementTag.ElementTag.Field] });
  }
  /**
   * Global attributes.
   */
  get attributes() {
    return this.scope.membersOf(this, { tags: [import_ElementTag.ElementTag.Attribute] });
  }
  /**
   * Fabrics.
   */

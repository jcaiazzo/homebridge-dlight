...
var writable_exports = {};
__export(writable_exports, {
  writable: () => writable
});
module.exports = __toCommonJS(writable_exports);
 ...
 */
const writable = (0, import_general.Decorator)((_target, context) => {
  const model = import_FieldSemantics.FieldSemantics.of(context).mutableModel;
  if (!(model instanceof import_ValueModel.ValueModel)) {
    throw new import_errors.InvalidMetadataError("Only value models may be writable");
  }
  model.access = new import_aspects.Access({ ...model.access, rw: import_aspects.Access.Rw.ReadWrite });
});

  ...
  children: [
    {
      tag: "field",
      name: "CommonClosure",
      details: "The tags contained in this namespace may be used in any domain or context, to indicate an association with a feature of a Closure, e.g. the button to activate opening a garage door.\n> [!NOTE]\n> NOTE: This namespace has been deprecated as of Matter 1.4.2. Clients SHOULD still have support for these tags, since the tags could be used by a server certified on a previous revision of Matter."
    },
    {
      tag: "field",
      name: "CommonCompassDirection",
    ...
    {
      tag: "field",
      name: "CommodityTariffChronology",
      details: "The tags contained in this namespace are restricted for use in the energy calendar domain and shall NOT be used in any other domain or context."
    },
    {
      tag: "field",
      name: "CommodityTariffCommodity",
      details: "The tags contained in this namespace are restricted for use in the Commodity Tariff commodity domain and shall NOT be used in any other domain or context."
    },
    {
      tag: "field",
      name: "Laundry",
    ...
    {
      tag: "field",
      name: "CommodityTariffFlow",
      details: "The tags contained in this namespace are restricted for use in the Commodity Tariff flow domain and shall NOT be used in any other domain or context."
    },
    {
      tag: "field",
      name: "Refrigerator",
    ...
    },
    {
      tag: "field",
      name: "Closure",
      details: "The tags contained in this namespace are restricted for use in the closure domain and shall NOT be used in any other domain or context."
    },
    {
      tag: "field",
      name: "ClosurePanel",
      details: "The tags contained in this namespace are restricted for use in the closure panel domain and shall NOT be used in any other domain or context."
    },
    {
      tag: "field",
      name: "ClosureCovering",
      details: "The tags contained in this namespace are restricted for use in the closure domain and shall NOT be used in any other domain or context."
    },
    {
      tag: "field",

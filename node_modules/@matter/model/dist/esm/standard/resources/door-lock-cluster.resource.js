    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            details: "Locks that support this feature implement the Aliro specification as defined in [[Aliro]](#ref_Aliro) and support Matter as a method for provisioning Aliro credentials."
          },
          {
            tag: "field",
            name: "ALBU",
            xref: "cluster\xA75.2.4.13",
            details: "Locks that support this feature implement the Bluetooth LE + UWB Access Control Flow as defined in [[Aliro]](#ref_Aliro)."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        details: `Indicates the verification key component of the Reader's key pair as defined in [[Aliro]](#ref_Aliro). The value, if not null, shall be an uncompressed elliptic curve public key as defined in section 2.3.3 of SEC 1.
Null if no Reader key pair has been configured on the lock. See Section 5.2.10.26, "SetAliroReaderConfig Command".`
      },
      {
        tag: "attribute",
        name: "AliroReaderGroupIdentifier",
        xref: "cluster\xA75.2.9.38",
        details: 'Indicates the reader_group_identifier as defined in [[Aliro]](#ref_Aliro).\nNull if no reader_group_identifier has been configured on the lock. See Section 5.2.10.26, "SetAliroReaderConfig Command".'
      },
      {
        tag: "attribute",
      ...
      },
      {
        ...
        details: "Indicates the list of protocol versions supported for expedited transactions as defined in [[Aliro]](#ref_Aliro)."
      },
      {
        tag: "attribute",
        name: "AliroGroupResolvingKey",
        xref: "cluster\xA75.2.9.41",
        details: 'Indicates the Group Resolving Key as defined in [[Aliro]](#ref_Aliro).\nNull if no group resolving key has been configured on the lock. See Section 5.2.10.26, "SetAliroReaderConfig Command".'
      },
      {
        tag: "attribute",
        name: "AliroSupportedBleuwbProtocolVersions",
        xref: "cluster\xA75.2.9.42",
        details: "Indicates the list of protocol versions supported for the Bluetooth LE + UWB Access Control Flow as defined in [[Aliro]](#ref_Aliro)."
      },
      {
        tag: "attribute",
        ...
        children: [
          {
            tag: "field",
            name: "WeekDayIndex",
            xref: "cluster\xA75.2.10.6.1",
            details: "This field shall indicate the index of the Week Day schedule."
          },
          {
            tag: "field",
            name: "UserIndex",
            xref: "cluster\xA75.2.10.6.2",
            details: "This field shall indicate the user ID."
          },
          {
            tag: "field",
            name: "Status",
            xref: "cluster\xA75.2.10.6.3",
          ...
          },
          {
            tag: "field",
            name: "StartHour",
            xref: "cluster\xA75.2.10.6.4",
            details: "This field shall indicate the starting hour for the Week Day schedule."
          },
          {
            tag: "field",
            name: "StartMinute",
            xref: "cluster\xA75.2.10.6.5",
            details: "This field shall indicate the starting minute for the Week Day schedule."
          },
          {
            tag: "field",
            name: "EndHour",
            xref: "cluster\xA75.2.10.6.6",
            details: "This field shall indicate the ending hour for the Week Day schedule. EndHour shall be equal to or greater than StartHour."
          },
          {
            tag: "field",
            name: "EndMinute",
            xref: "cluster\xA75.2.10.6.7",
            details: "This field shall indicate the ending minute for the Week Day schedule. If EndHour is equal to StartHour then EndMinute shall be greater than StartMinute."
          }
        ]
      },
        ...
        children: [
          {
            tag: "field",
            name: "YearDayIndex",
            xref: "cluster\xA75.2.10.8.1",
            details: "This field shall indicate the index of the Year Day schedule."
          },
          {
            tag: "field",
            name: "UserIndex",
            xref: "cluster\xA75.2.10.8.2",
            details: "This field shall indicate the user ID."
          },
          {
            tag: "field",
            name: "LocalStartTime",
            xref: "cluster\xA75.2.10.8.3",
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            tag: "field",
            name: "UserIndex",
            xref: "cluster\xA75.2.10.10.2",
            details: "This field shall indicate the user ID."
          },
          {
            tag: "field",
            name: "Status",
            xref: "cluster\xA75.2.10.10.3",
      ...
      },
      {
        ...
        children: [
          ...
          { tag: "field", name: "UserUniqueId", xref: "cluster\xA75.2.10.18.3", details: "See UserUniqueID." },
          {
            tag: "field",
            name: "UserStatus",
      ...
      },
      {
        ...
        details: "This command allows communicating an Aliro Reader configuration, as defined in [[Aliro]](#ref_Aliro), to the lock.",
        children: [
          {
            tag: "field",
            name: "SigningKey",
            xref: "cluster\xA75.2.10.26.1",
            details: "This field shall indicate the signing key component of the Reader's key pair."
          },
          {
            tag: "field",
            name: "VerificationKey",
            xref: "cluster\xA75.2.10.26.2",
      ...
      },
      {
        ...
        details: "This command allows clearing an existing Aliro Reader configuration for the lock.\nAdministrators shall NOT clear an Aliro Reader configuration without explicit user permission.\n> [!NOTE]\n> NOTE: Using this command will revoke the ability of all existing Aliro user devices that have the old verification key to interact with the lock. This effect is not restricted to a single fabric or otherwise scoped in any way."
      },
      {
        tag: "datatype",
        name: "DaysMaskBitmap",
      ...
      },
      {
        ...
        details: "> [!NOTE]\n> WARNING: For the OperatingModesBitmap, a bit SET indicates that the operating mode IS NOT   supported. A bit CLEAR indicates that the operating mode IS supported. This is the inverse of most bitmaps in this specification, and it is recommended that clients carefully take this into   consideration. See SupportedOperatingModes.",
        children: [

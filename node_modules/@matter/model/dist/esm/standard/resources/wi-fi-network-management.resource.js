  ...
  children: [
    ...
    },
    {
      ...
      children: [{
        ...
        details: "This field shall indicate the current WPA-Personal passphrase or PSK associated with the primary Wi-Fi network provided by this device, in one of the following formats:\n  - 8..63 bytes: WPA/WPA2/WPA3 passphrase.\n  - 64 bytes: WPA/WPA2/WPA3 raw hex PSK. Each byte shall be a ASCII hexadecimal digit.\nThis matches the formats defined for WPA networks by the Credentials field in the Network Commissioning cluster (see [[MatterCore]](#ref_MatterCore)).\n> [!NOTE]\n> NOTE: WPA3-Personal permits passphrases shorter than 8 or longer than 63 characters, however the Network Commissioning cluster does not currently support configuring Matter devices to connect to operational networks utilizing such a passphrase."
      }]
    }
  ]
});

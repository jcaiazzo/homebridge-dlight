      ...
      children: [
        {
          tag: "field",
          name: "Node",
          xref: "core\xA711.8.5.1.1",
          details: "This field shall indicate the ID of a node which is on the electrical circuit represented by this server."
        },
        {
          tag: "field",
          name: "Endpoint",
          xref: "core\xA711.8.5.1.2",
          details: "This field shall indicate the endpoint ID of the indicated node which is on the electrical circuit represented by this server."
        },
        {
          tag: "field",
          name: "Label",
          xref: "core\xA711.8.5.1.3",
          details: "This field shall indicate a friendly name for the node, to be used when the client does not have access to the node's fabric."
        }
      ]
    }
  ]

...
Resource.add({
  ...
  children: [
    { tag: "requirement", name: "Identify", xref: "device\xA714.4.5" },
    { tag: "requirement", name: "SolarPower", xref: "device\xA714.4.6" },
    { tag: "requirement", name: "TemperatureSensor", xref: "device\xA714.4.6" },
    { tag: "requirement", name: "DeviceEnergyManagement", xref: "device\xA714.4.6" }
  ]
});

...
Resource.add(
  {
    ...
    pics: "CLDIM",
    xref: "cluster\xA75.5",
    details: 'This cluster provides an interface for controlling a single degree of freedom (also referred to as a "dimension" or an "axis" below) of a composed closure. This could be a degree of freedom in a 6-axis framework for the overall closure or a panel in the closure, or some other degree of freedom.\nAn instance of this cluster may represent position along a single axis, as specified by the FeatureMap, which can be one of:\n  - Translation : panel translates along one axis\n  - Rotation : panel rotates around an axis of rotation\n  - Modulation : panel modifies its aspect to modulate a flow\nThis cluster may also be used to latch or anchor a panel in a position, if the panel supports that.',
    children: [
      {
        tag: "attribute",
        name: "FeatureMap",
        xref: "cluster\xA75.5.5",
        children: [
          {
            tag: "field",
            name: "PS",
            xref: "cluster\xA75.5.5.1",
            details: "This feature shall indicate support for position percentage over the range of 0.00% to 100.00%, with a resolution of 0.01%.\n> [!NOTE]\n> NOTE: In most of the products 0.00% = fully opened and 100.00% = fully closed but this is not always the case. For example, if the Modulation feature is supported and the ModulationType is SlatsOrientation or StripesAlignment, the panel can be fully closed at 0.00% and 100.00%, and be fully opened at 50.00%."
          },
          {
            tag: "field",
            name: "LT",
            xref: "cluster\xA75.5.5.2",
            details: "This feature shall indicate that the closure can be latched and unlatched. An axis with the MotionLatching feature has capabilities that will prevent actuators from moving along parts of that axis if the dimension is latched."
          },
          {
            tag: "field",
            name: "UT",
            xref: "cluster\xA75.5.5.3",
            details: "This feature shall indicate additional information about the closure dimension's possible range of movement."
          },
          {
            tag: "field",
            name: "LM",
            xref: "cluster\xA75.5.5.4",
            details: "This feature shall indicate that the closure dimension supports degradation of its functioning. Reachable Position range may be limited compared to full scope of a nominal behavior."
          },
          {
            tag: "field",
            name: "SP",
            xref: "cluster\xA75.5.5.5",
            details: 'This feature shall indicate that the closure dimension can be driven at different speed levels: Low, Medium, and High. Please refer to Section 5.4.5.4, "Speed Feature" for more details.\n> [!NOTE]\n> NOTE: The server might not support three different speed values. The manufacturer shall select speed values linked to Low, Medium and High such that Low $<=$ Medium $<=$ High.'
          },
          {
            tag: "field",
            name: "TR",
            xref: "cluster\xA75.5.5.6",
            details: "This feature shall indicate that the panel can move along a single axis. The possible directions include downward, upward, leftward, rightward, forward, and backward. The Translation feature is used to control the position of the panel along the specified axis."
          },
          {
            tag: "field",
            name: "RO",
            xref: "cluster\xA75.5.5.7",
            details: "This feature shall indicate that the panel can rotate around a single axis. The possible axes include left, right, top, bottom, centered vertical, and centered horizontal. The Rotation feature is used to control the orientation of the panel around the specified axis."
          },
          {
            tag: "field",
            name: "MD",
            xref: "cluster\xA75.5.5.8",
            details: "This feature shall indicate that the panel can modify its aspect to control a particular flow, such as light, air, or privacy. The possible modulation types include slats orientation, slats openwork, stripes alignment, opacity, and ventilation. The Modulation feature is used to adjust the panel's properties to achieve the desired effect."
          }
        ]
      },
      {
      ...
      },
      {
        tag: "attribute",
        name: "Resolution",
        xref: "cluster\xA75.5.7.3",
        details: "Indicates the minimal acceptable change to the Position field of the TargetState and CurrentState attributes.\nResolution should not be confused with an accuracy, such as Current = Target +/- Accuracy. This cluster does not provide accuracy.\nResolution gives a collection of valid Current position points over a linear ruler.\n> [!NOTE]\n> NOTE: A resolution of 100% means that the associated dimension cannot be placed in an intermediate position - its position is binary."
      },
      {
        tag: "attribute",
        name: "StepValue",
        xref: "cluster\xA75.5.7.4",
        details: "Indicates the size of a single step, expressed in percent100ths. When the Step command is used, each step changes the position by this amount. The value of this attribute shall be an integer multiple of the Resolution attribute.\n> [!NOTE]\n> NOTE: The StepValue should be large enough to cause a visible change in the closure's position when a Step command is invoked."
      },
      {
        tag: "attribute",
        name: "Unit",
        xref: "cluster\xA75.5.7.5",
        details: "Indicates the unit related to the Position."
      },
      {
        tag: "attribute",
        name: "UnitRange",
        xref: "cluster\xA75.5.7.6",
        details: 'Indicates the minimum and the maximum values expressed by Position following the unit indicated by "Unit".\nThe value of this attribute may be null if the product has not been set up.'
      },
      {
        tag: "attribute",
        name: "LimitRange",
        xref: "cluster\xA75.5.7.7",
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            tag: "field",
            name: "NumberOfSteps",
            xref: "cluster\xA75.5.8.2.2",
            details: 'This field shall indicate the number of steps by which the position should be changed. The size of one step, expressed in percent100ths, is determined by the "StepValue" attribute.'
          },
          {
            tag: "field",
            name: "Speed",
            xref: "cluster\xA75.5.8.2.3",
      ...
      {
        tag: "datatype",
        name: "TranslationDirectionEnum",
        xref: "cluster\xA75.5.6.1",
      ...
      {
        tag: "datatype",
        name: "ModulationTypeEnum",
        xref: "cluster\xA75.5.6.4",
        children: [
      ...
      {
        tag: "datatype",
        name: "ClosureUnitEnum",
        xref: "cluster\xA75.5.6.5",
        children: [
      ...
      },
      {
        ...
        xref: "cluster\xA75.5.6.6",
        details: "This data type is derived from enum8 and used for the Step command to indicate the direction of the steps.",
        children: [
          { tag: "field", name: "Decrease", description: "Decrease towards 0.00%" },
          { tag: "field", name: "Increase", description: "Increase towards 100.00%" }
        ]
      },
      { tag: "datatype", name: "RangePercent100thsStruct", xref: "cluster\xA75.5.6.7" },
      { tag: "datatype", name: "UnitRangeStruct", xref: "cluster\xA75.5.6.8" },
      {
        tag: "datatype",
        name: "DimensionStateStruct",
        xref: "cluster\xA75.5.6.9",
        children: [
          {
            tag: "field",
            name: "Position",
            xref: "cluster\xA75.5.6.9.1",
            details: "This field shall indicate the position of the closure, expressed as a percentage from 0.00% to 100.00%.\nA null value indicates that the position is not known or is not set."
          },
          {
            tag: "field",
            name: "Latch",
            xref: "cluster\xA75.5.6.9.2",
            details: "This field shall indicate the latching state of the closure, as defined in the OverallCurrentStateStruct Latch Field.\nA null value indicates that the latch is not known or is not set."
          },
          {
            tag: "field",
            name: "Speed",
            xref: "cluster\xA75.5.6.9.3",
      ...
      {
        tag: "datatype",
        name: "LatchControlModesBitmap",
        xref: "cluster\xA75.5.6.10",
        children: [
          {
            tag: "field",
            name: "RemoteLatching",
            description: "Remote latching capability",
            xref: "cluster\xA75.5.6.10.1",
          ...
          {
            tag: "field",
            name: "RemoteUnlatching",
            description: "Remote unlatching capability",
            xref: "cluster\xA75.5.6.10.2",
...
//# sourceMappingURL=closure-dimension.resource.js.map

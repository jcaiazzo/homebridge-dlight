...
This cluster also represents responsibilities related to commissioning that don't well fit other commissioning clusters, like Section 11.9, "Network Commissioning Cluster". It also hosts functionalities those other clusters may depend on.`,
    children: [
      ...
      },
      {
        ...
        details: 'This attribute shall describe critical parameters needed at the beginning of commissioning flow. See Section 11.10.5.4, "BasicCommissioningInfo" for more information.'
      },
      {
        tag: "attribute",
      ...
      },
      {
        ...
        xref: "core\xA711.10.6.11",
        details: "This attribute shall contain the identifier to be included in the advertisements used during the Network Recovery Flow. This identifier is intended to be advertised over the air and used by an Administrator to establish a Node's identity without revealing its Node ID.\nThe attribute shall contain a random 64-bit value, that value shall be reset on factory reset and shall remain unchanged until a next factory reset. It is important that this value be selected at random from a 64-bit number space to ensure a high likelihood of uniqueness from values selected by other Nodes. This value SHOULD be obtained through Crypto_DRBG(len = 64)."
      },
      {
        tag: "attribute",
        name: "NetworkRecoveryReason",
        xref: "core\xA711.10.6.12",
        details: "This attribute shall contain the primary reason that triggered the Network Recovery flow and its associated advertisements. Null when the Node is not undergoing a Network Recovery flow."
      },
      {
        tag: "attribute",
        name: "IsCommissioningWithoutPower",
        xref: "core\xA711.10.6.13",
        details: 'The server shall set this attribute to true if and only if is currently operating on the commissioning channel but cannot operate on the operational channel because it is not powered.\nThis may happen during NFC-based commissioning, when the commissioning channel is NFC Transport Layer (NTL), because it can harvest energy from NFC to operate. However, such a Commissionee must be powered on to switch to the operational channel.\nThis attribute is used by the Commissioner as described in step 18 of Section 5.5, "Commissioning Flows". This attribute is linked to the Commissionee behavior after reception of the ConnectNetwork Command.'
      },
      {
        tag: "command",
        name: "ArmFailSafe",
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            details: 'This field shall contain the user responses to the Enhanced Setup Flow Terms & Conditions as a map where each bit set in the bitmap corresponds to an accepted term in the file located at Section 11.23.6.22, "EnhancedSetupFlowTCUrl".'
          }
        ]
      },
      {

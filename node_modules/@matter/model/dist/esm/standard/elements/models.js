...
const ZoneManagement = new ClusterModel(definitions.ZoneManagement);
const SoilMeasurement = new ClusterModel(definitions.SoilMeasurement);
...
const ClosureControl = new ClusterModel(definitions.ClosureControl);
const ClosureDimension = new ClusterModel(definitions.ClosureDimension);
...
const CommodityPrice = new ClusterModel(definitions.CommodityPrice);
const MeterIdentification = new ClusterModel(definitions.MeterIdentification);
const CommodityMetering = new ClusterModel(definitions.CommodityMetering);
const CommodityTariff = new ClusterModel(definitions.CommodityTariff);
const ElectricalGridConditions = new ClusterModel(definitions.ElectricalGridConditions);
...
const CameraAvStreamManagement = new ClusterModel(definitions.CameraAvStreamManagement);
const CameraAvSettingsUserLevelManagement = new ClusterModel(definitions.CameraAvSettingsUserLevelManagement);
const WebRtcTransportDefinitions = new ClusterModel(definitions.WebRtcTransportDefinitions);
const WebRtcTransportProvider = new ClusterModel(definitions.WebRtcTransportProvider);
const WebRtcTransportRequestor = new ClusterModel(definitions.WebRtcTransportRequestor);
const PushAvStreamTransport = new ClusterModel(definitions.PushAvStreamTransport);
const Chime = new ClusterModel(definitions.Chime);
...
const TlsCertificateManagement = new ClusterModel(definitions.TlsCertificateManagement);
const TlsClientManagement = new ClusterModel(definitions.TlsClientManagement);
...
const TariffUnitEnum = new DatatypeModel(definitions.TariffUnitEnum);
const PowerThresholdSourceEnum = new DatatypeModel(definitions.PowerThresholdSourceEnum);
const TariffPriceTypeEnum = new DatatypeModel(definitions.TariffPriceTypeEnum);
const PowerThresholdStruct = new DatatypeModel(definitions.PowerThresholdStruct);
const StreamUsageEnum = new DatatypeModel(definitions.StreamUsageEnum);
const ViewportStruct = new DatatypeModel(definitions.ViewportStruct);
...
const IrrigationSystemDt = new DeviceTypeModel(definitions.IrrigationSystemDt);
...
const SoilSensorDt = new DeviceTypeModel(definitions.SoilSensorDt);
...
const ClosureDt = new DeviceTypeModel(definitions.ClosureDt);
const ClosurePanelDt = new DeviceTypeModel(definitions.ClosurePanelDt);
const ClosureControllerDt = new DeviceTypeModel(definitions.ClosureControllerDt);
...
const MeterReferencePointDt = new DeviceTypeModel(definitions.MeterReferencePointDt);
const ElectricalEnergyTariffDt = new DeviceTypeModel(definitions.ElectricalEnergyTariffDt);
const ElectricalMeterDt = new DeviceTypeModel(definitions.ElectricalMeterDt);
const ElectricalUtilityMeterDt = new DeviceTypeModel(definitions.ElectricalUtilityMeterDt);
const NetworkInfrastructureManagerDt = new DeviceTypeModel(definitions.NetworkInfrastructureManagerDt);
const ThreadBorderRouterDt = new DeviceTypeModel(definitions.ThreadBorderRouterDt);
const CameraDt = new DeviceTypeModel(definitions.CameraDt);
const FloodlightCameraDt = new DeviceTypeModel(definitions.FloodlightCameraDt);
const VideoDoorbellDt = new DeviceTypeModel(definitions.VideoDoorbellDt);
const IntercomDt = new DeviceTypeModel(definitions.IntercomDt);
const AudioDoorbellDt = new DeviceTypeModel(definitions.AudioDoorbellDt);
const SnapshotCameraDt = new DeviceTypeModel(definitions.SnapshotCameraDt);
const ChimeDt = new DeviceTypeModel(definitions.ChimeDt);
const CameraControllerDt = new DeviceTypeModel(definitions.CameraControllerDt);
const DoorbellDt = new DeviceTypeModel(definitions.DoorbellDt);
const CommonClosureNs = new SemanticNamespaceModel(definitions.CommonClosureNs);
const CommonCompassDirectionNs = new SemanticNamespaceModel(definitions.CommonCompassDirectionNs);
const CommonCompassLocationNs = new SemanticNamespaceModel(definitions.CommonCompassLocationNs);
const CommonDirectionNs = new SemanticNamespaceModel(definitions.CommonDirectionNs);
const CommonLevelNs = new SemanticNamespaceModel(definitions.CommonLevelNs);
const CommonLocationNs = new SemanticNamespaceModel(definitions.CommonLocationNs);
const CommonNumberNs = new SemanticNamespaceModel(definitions.CommonNumberNs);
const CommonPositionNs = new SemanticNamespaceModel(definitions.CommonPositionNs);
const ElectricalMeasurementNs = new SemanticNamespaceModel(definitions.ElectricalMeasurementNs);
const CommodityTariffChronologyNs = new SemanticNamespaceModel(definitions.CommodityTariffChronologyNs);
const CommodityTariffCommodityNs = new SemanticNamespaceModel(definitions.CommodityTariffCommodityNs);
...
const CommonAreaNamespaceNs = new SemanticNamespaceModel(definitions.CommonAreaNamespaceNs);
const CommonLandmarkNamespaceNs = new SemanticNamespaceModel(definitions.CommonLandmarkNamespaceNs);
const CommonRelativePositionNs = new SemanticNamespaceModel(definitions.CommonRelativePositionNs);
const CommodityTariffFlowNs = new SemanticNamespaceModel(definitions.CommodityTariffFlowNs);
...
const ClosurePanelNs = new SemanticNamespaceModel(definitions.ClosurePanelNs);
const ClosureCoveringNs = new SemanticNamespaceModel(definitions.ClosureCoveringNs);
const ClosureWindowNs = new SemanticNamespaceModel(definitions.ClosureWindowNs);
const ClosureCabinetNs = new SemanticNamespaceModel(definitions.ClosureCabinetNs);
export {
  AcceptedCommandList,
  AccessControl,
  AccountLogin,
  ...
  CommodityPrice,
  CommodityTariff,
  CommodityTariffChronologyNs,
  CommodityTariffCommodityNs,
  CommodityTariffFlowNs,
  CommonAreaNamespaceNs,
  CommonClosureNs,
  CommonCompassDirectionNs,
  CommonCompassLocationNs,
  CommonDirectionNs,
  CommonLandmarkNamespaceNs,
  CommonLevelNs,
  CommonLocationNs,
  CommonNumberNs,
  CommonPositionNs,
  CommonRelativePositionNs,

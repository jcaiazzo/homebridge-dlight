...
const RefrigeratorDt = DeviceType(
  { name: "Refrigerator", id: 112, classification: "simple" },
  Requirement(
  ...
  Requirement({ name: "RefrigeratorAlarm", id: 87, conformance: "O", element: "serverCluster" }),
  Requirement({ name: "TemperatureControlledCabinet", id: 113, conformance: "M", element: "deviceType" })
);

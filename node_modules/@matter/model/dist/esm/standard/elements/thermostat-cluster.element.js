...
const Thermostat = Cluster(
  ...
  Attribute({ name: "LocalTemperature", id: 0, type: "temperature", access: "R V", conformance: "M", quality: "X" }),
  Attribute({
  ...
  Attribute({ name: "Occupancy", id: 2, type: "OccupancyBitmap", access: "R V", conformance: "OCC" }),
  Attribute({
  ...
  Attribute({ name: "PiCoolingDemand", id: 7, conformance: "D" }),
  Attribute({ name: "PiHeatingDemand", id: 8, conformance: "D" }),
  Attribute({ name: "HvacSystemTypeConfiguration", id: 9, conformance: "D" }),
  Attribute({
  ...
  Attribute({ name: "ThermostatProgrammingOperationMode", id: 37, conformance: "D" }),
  Attribute({
  ...
  Attribute({ name: "SetpointChangeSourceTimestamp", id: 50, type: "epoch-s", access: "R V", conformance: "O" }),
  Attribute({ name: "OccupiedSetback", id: 52, conformance: "D" }),
  Attribute({ name: "OccupiedSetbackMin", id: 53, conformance: "D" }),
  Attribute({ name: "OccupiedSetbackMax", id: 54, conformance: "D" }),
  Attribute({ name: "UnoccupiedSetback", id: 55, conformance: "D" }),
  Attribute({ name: "UnoccupiedSetbackMin", id: 56, conformance: "D" }),
  Attribute({ name: "UnoccupiedSetbackMax", id: 57, conformance: "D" }),
  Attribute({
  ...
  Datatype(
    ...
    Field({ name: "Schedule", id: 1, conformance: "[MSCH]" }),

...
class Constraint extends Aspect {
  ...
  constructor(definition) {
    ...
    this.isEmpty = this.none === void 0 && this.desc === void 0 && this.value === void 0 && this.min === void 0 && this.max === void 0 && this.in === void 0 && this.entry === void 0 && this.cpMax === void 0 && this.parts === void 0;
    this.freeze();
  }
  extend(other) {
    if (other.isEmpty) {
  ...
  test(value, nameResolver) {
    function valueOf(value2, raw = false) {
      ...
      if (typeof value2 === "object" && value2 !== null && "type" in value2) {
        ...
        switch (type) {
          ...
          case "maxOf":
          case "minOf": {
            return Functions[type](value2.args.map((value3) => valueOf(value3)));
          }
        }
      }
      return value2;
    ...
    if (typeof v === "bigint" && typeof value === "number" || typeof v === "number" && typeof value === "bigint") {
      if (v == value) {
        return true;
      }
    }
...
((Constraint2) => {
  Constraint2.KEYWORDS = ["in", "min", "max", "to", "all", "none", "desc", "true", "false"];
...
((Parser2) => {
  ...
  function parse(constraint, definition) {
    ...
    function parsePrimary() {
      ...
      if (value !== void 0 && tokens.token?.type === "(") {

...
import { Crypto, CRYPTO_SYMMETRIC_KEY_LENGTH, ec } from "./Crypto.js";
...
class StandardCrypto extends Crypto {
  ...
  ecMultiply(point, scalar) {
    return ec.p256.Point.fromBytes(Bytes.of(point)).multiply(Bytes.asBigInt(Bytes.of(scalar))).toBytes(false);
  }

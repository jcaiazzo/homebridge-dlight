...
export declare const DEFAULT_MAX_TCP_MESSAGE_SIZE = 64000;
/** Time to wait for a TCP connection to be established before giving up. */
export declare const TCP_CONNECTION_TIMEOUT_MS = 10000;
/** Keep-alive initial delay for TCP connections — idle time before first keep-alive probe. */
export declare const TCP_KEEP_ALIVE_INITIAL_DELAY_MS = 30000;

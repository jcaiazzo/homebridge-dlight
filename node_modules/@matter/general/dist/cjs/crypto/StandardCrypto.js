...
class StandardCrypto extends import_Crypto.Crypto {
  ...
  ecMultiply(point, scalar) {
    return import_Crypto.ec.p256.Point.fromBytes(import_Bytes.Bytes.of(point)).multiply(import_Bytes.Bytes.asBigInt(import_Bytes.Bytes.of(scalar))).toBytes(false);
  }
...
if ("crypto" in globalThis && globalThis.crypto?.subtle && !import_Environment.Environment.default.has(import_Crypto.Crypto)) {

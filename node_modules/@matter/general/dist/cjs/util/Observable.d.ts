...
export declare class BasicObservable<T extends any[] = any[], R = void> implements Observable<T, R> {
    ...
    [Symbol.dispose](): void;
    protected handleError(error: Error, _observer: Observer<any[], any>): void;
    ...
    attachObservers(detached: DetachedObservers<T, R>): void;
}
/**
 ...
 */
export declare const AsyncObservableValue: {
...
export declare class EventEmitter {
    ...
    addEvent(name: string, event?: AsyncObservable): void;
    getEvent(name: string): AsyncObservable<any[], void>;
    hasEvent(name: string, onlyIfInitialized?: boolean): boolean | AsyncObservable<any[], void> | undefined;
...
export declare class ObserverGroup {
    #private;
    constructor(target?: {});
    on<T extends any[], R>(observable: Observable<T, R>, observer: Observer<ObserverGroup.VarArgs<NoInfer<T>>, NoInfer<R>>, target?: {}): void;
    on<T extends any[], R>(observable: AsyncObservable<T, R>, observer: AsyncObserver<ObserverGroup.VarArgs<NoInfer<T>>, NoInfer<R>>, target?: {}): void;
    /**
     ...
     * @param observable the observable to observe
     */
    observes(observable: Observable<any[], any> | AsyncObservable<any>): number | boolean;
    /**
     ...
     * @param observer the observer function
     */
    has(observable: Observable<any[], any> | AsyncObservable<any>, observer: Observer<any[], any>): boolean;
    /**
 ...
 */
export declare class QuietObservable<T extends any[] = any[], R extends MaybePromise<void> = void> extends BasicObservable<T, R> implements QuietObservable.State<T, R> {
    #private;
    constructor(config?: QuietObservable.Configuration<T, R>);
    get config(): QuietObservable.Configuration<T, R>;
    ...
    get minimumEmitInterval(): Duration;
    set minimumEmitInterval(value: Duration);
    get source(): Observable<T, R> | undefined;
    set source(source: Observable<T, R> | undefined);
    get sink(): Observable<T, R> | undefined;
...
export declare namespace QuietObservable {
    interface State<T extends any[] = any[], R extends MaybePromise<void> = void> {
        /**
    ...
    interface Configuration<T extends any[] = any[], R extends MaybePromise<void> = void> extends Partial<State<T, R>> {
    }

...
export declare class Abort extends Callable<[reason?: string | Error]> implements AbortController, AbortSignal, PromiseLike<Error> {
     ...
     */
    sleep(description: string, duration: Duration): Promise<void>;
    /**
     * Free resources.
     *
    ...
    get reason(): any;
    throwIfAborted(): void;
    then<TResult1 = void, TResult2 = never>(onfulfilled?: ((value: Error) => TResult1 | PromiseLike<TResult1>) | null, onrejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | null): Promise<TResult1 | TResult2>;

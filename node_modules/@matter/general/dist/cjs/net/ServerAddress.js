...
((ServerAddress2) => {
  ...
  function diagnosticFor(address) {
    ...
    if (isIp(address)) {
      diagnostic.push(`${protocolOf(address)}://`, import_Diagnostic.Diagnostic.strong(address.ip), ":", address.port);

...
const PairingHintBitmap = {
   ...
   */
  pressAndReleaseSetupButtonNumberOfTimes: (0, import_types.BitFlag)(20),
  /**
   ...
   * key.
   */
  pressButtonForNumberOfSecondsWithIndication: (0, import_types.BitFlag)(21),
  /**
   ...
   */
  powerCycleUntilIndication: (0, import_types.BitFlag)(22)
};

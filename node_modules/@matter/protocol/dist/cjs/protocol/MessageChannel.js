...
class MessageChannel {
  ...
  async send(message, options) {
    ...
    if (addressOverride && (0, import_general.isUdpNetworkChannel)(this.#channel)) {
  ...
  #observeChannelAddress(newChannel) {
    ...
    this.#channelAddressObserver = (networkAddress) => {
      logger.debug(`Network address of channel changed to ${import_general.ServerAddress.urlFor(networkAddress)}`);
  ...
  async close() {
    ...
    if (this.#channel.type !== import_general.ChannelType.TCP) {

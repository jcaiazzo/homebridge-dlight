...
import { AsyncObservable, Bytes, Channel, ChannelType, Crypto, MaybePromise, Observable, ServerAddressUdp, UdpNetworkChannel } from "@matter/general";
...
export declare namespace ProtocolMocks {
     ...
     */
    class NetworkChannel implements UdpNetworkChannel<Bytes> {
        #private;

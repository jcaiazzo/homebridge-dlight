  ...
  async onNewExchange(exchange) {
    ...
    try {
      ...
      try {
        ...
        if (this.#subscriptions.readingAbortSignal.aborted && (0, import_general.causedBy)(error, import_general.AbortedError)) {

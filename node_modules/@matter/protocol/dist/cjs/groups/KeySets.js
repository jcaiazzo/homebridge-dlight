...
class KeySets extends import_general.BasicSet {
  ...
  allKeysForId(keySetId) {
    ...
    operationalKeys.push({
      ...
      startTime: import_general.Timestamp.fromMicroseconds(epochStartTime0)
    });
    if (operationalEpochKey1 !== null && groupSessionId1 !== null && epochStartTime1 !== null) {
      operationalKeys.push({
        key: operationalEpochKey1,
        sessionId: groupSessionId1,
        startTime: import_general.Timestamp.fromMicroseconds(epochStartTime1)
      });
    }
    if (operationalEpochKey2 !== null && groupSessionId2 !== null && epochStartTime2 !== null) {
      operationalKeys.push({
        ...
        startTime: import_general.Timestamp.fromMicroseconds(epochStartTime2)
      });
    }

...
__export(FabricGroups_exports, {
  ...
  IPK_DEFAULT_EPOCH_START_TIME: () => IPK_DEFAULT_EPOCH_START_TIME
});
...
const IPK_DEFAULT_EPOCH_START_TIME = import_types.MATTER_EPOCH_OFFSET_US;
class FabricGroups {
  #fabric;
  #groups;
  #messagingState;
  ...
  */
  ...
  async setFromGroupKeySet(groupKeySet) {
    ...
    const globalId = import_general.Bytes.fromHex(import_general.hex.fixed(this.#fabric.globalId, 16));

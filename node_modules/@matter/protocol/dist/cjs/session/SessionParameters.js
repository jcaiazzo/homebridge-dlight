...
var SessionParameters_exports = {};
__export(SessionParameters_exports, {
  SessionParameters: () => SessionParameters
});
module.exports = __toCommonJS(SessionParameters_exports);
var import_SupportedTransportsBitmap = require("#common/SupportedTransportsBitmap.js");
var import_model = require("@matter/model");
var import_SessionIntervals = require("./SessionIntervals.js");
/**
 * @license
...
function SessionParameters(config) {
  ...
  if (typeof supportedTransports === "number") {
    supportedTransports = import_SupportedTransportsBitmap.SupportedTransportsSchema.decode(supportedTransports);
  }
...
((SessionParameters2) => {
  SessionParameters2.fallbacks = {
    ...import_SessionIntervals.SessionIntervals.defaults,
    /**

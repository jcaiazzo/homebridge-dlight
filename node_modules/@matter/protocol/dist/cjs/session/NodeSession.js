...
class NodeSession extends import_SecureSession.SecureSession {
  ...
  get via() {
    const transport = !this.isClosed && this.channel.transportChannel.type !== import_general.ChannelType.UDP ? `(${this.channel.transportChannel.type})` : "";
    return import_general.Diagnostic.via(`${this.peerAddress.toString()}${import_Mark.Mark.SESSION}${import_general.hex.word(this.id)}${transport}`);
  }
  get peerSessionId() {

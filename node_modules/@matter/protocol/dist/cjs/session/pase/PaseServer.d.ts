...
import { Bytes, MatterFlowError, PbkdfParameters } from "@matter/general";
...
export declare class PaseServer implements ProtocolHandler {
    ...
    static fromVerificationValue(sessions: SessionManager, verificationValue: Bytes, pbkdfParameters?: PbkdfParameters): PaseServer;
    constructor(sessions: SessionManager, w0: bigint, L: Bytes, pbkdfParameters?: PbkdfParameters | undefined);

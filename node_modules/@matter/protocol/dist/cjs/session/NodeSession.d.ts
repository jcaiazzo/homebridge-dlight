...
import { AsyncObservableValue, BasicSet, Bytes, Crypto, Logger } from "@matter/general";
...
export declare class NodeSession extends SecureSession {
    ...
    get caseAuthenticatedTags(): readonly CaseAuthenticatedTag[];
    get isPase(): boolean;
    ...
    handlePeerClose(currentExchange?: MessageExchange): Promise<void>;
    handlePeerLoss(context: PeerLossContext): Promise<void>;

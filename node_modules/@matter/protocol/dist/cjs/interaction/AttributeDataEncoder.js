...
function canAttributePayloadBeChunked(attributePayload) {
  ...
  return tlv instanceof import_types.ArraySchema && Array.isArray(payload) && payload.length > 0 && listIndex === void 0;
}
function chunkAttributePayload(attributePayload) {
  ...
  if (!(tlv instanceof import_types.ArraySchema) || !Array.isArray(payload)) {
    throw new import_general.MatterFlowError(
  ...
  chunks.push({
    ...
    attributeData: { tlv, path: { ...path, listIndex: void 0 }, payload: [], dataVersion }
  });

...
import { Duration, MatterFlowError } from "@matter/general";
...
export declare class FailsafeTimer {
    ...
    constructor(associatedFabric: Fabric | undefined, expiryLength: Duration, maxCumulativeFailsafe: Duration, expiryCallback: (currentExchange?: MessageExchange) => Promise<void>);
    close(): Promise<void>;
    /** Handle "Re-Arming" an existing FailSafe context to extend the timer, expire or fail if not allowed. */
    reArm(associatedFabric: Fabric | undefined, expiry: Duration, currentExchange?: MessageExchange): Promise<void>;
    ...
    expire(currentExchange?: MessageExchange): Promise<void>;

...
const getFabricQname = (fabric) => `_I${import_types.GlobalFabricId.strOf(fabric).toUpperCase()}._sub.${MATTER_SERVICE_QNAME}`;
const getOperationalDeviceQname = (fabric, node) => `${import_types.GlobalFabricId.strOf(fabric).toUpperCase()}-${import_types.NodeId.strOf(node).toUpperCase()}.${MATTER_SERVICE_QNAME}`;

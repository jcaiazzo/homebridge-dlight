...
class DeviceCertification {
  ...
  #validateCertification(product) {
    const certificate = this.#certificate;
    const intermediateCertificate = this.#intermediateCertificate;
    if (certificate === void 0 || intermediateCertificate === void 0) {
      return;
    }
    const dac = import_AttestationCertificates.Dac.fromAsn1(certificate);
    const pai = import_AttestationCertificates.Pai.fromAsn1(intermediateCertificate);
    const dacVendorId = dac.cert.subject.vendorId;
    if (dacVendorId !== void 0 && dacVendorId !== product.vendorId) {

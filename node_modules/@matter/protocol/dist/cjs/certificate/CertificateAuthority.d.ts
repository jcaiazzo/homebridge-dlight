 ...
 */
import { BinaryKeyPair, Bytes, Construction, Crypto, Environment, Environmental, StorageContext } from "@matter/general";
...
export declare class CertificateAuthority {
    ...
    close(): import("@matter/general").MaybePromise;
    /**

...
import { BitField, BitFlag, Schema, TypeFromPartialBitSchema } from "@matter/types";
...
export declare const BdxTransferControlSchema: import("@matter/types").BitmapSchemaInternal<{
    /** Protocol Version, Only allowed version is 0.0 for now */
    version: BitField;
    /** Indicates if Sender drive is supported by Initiator */
    senderDrive: BitFlag;
...
export declare const BdxRangeControlSchema: import("@matter/types").BitmapSchemaInternal<{
    /** Indicates if the transfer has a definite length */
    definiteLength: BitFlag;
    /** Indicates if the transfer has a start offset */
    startOffset: BitFlag;

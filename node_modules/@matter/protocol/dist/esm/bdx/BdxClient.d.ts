...
export declare class BdxClient {
    ...
    get progressInfo(): import("@matter/general").Observable<[bytesTransferred: number, totalBytesLength: number | undefined], void>;
    get progressFinished(): import("@matter/general").Observable<[totalBytesTransferred: number], void>;
    get session(): BdxSession;

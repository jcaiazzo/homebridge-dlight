 ...
 */
import { GlobalFabricId, NodeId } from "@matter/types";
...
const getFabricQname = (fabric) => `_I${GlobalFabricId.strOf(fabric).toUpperCase()}._sub.${MATTER_SERVICE_QNAME}`;
const getOperationalDeviceQname = (fabric, node) => `${GlobalFabricId.strOf(fabric).toUpperCase()}-${NodeId.strOf(node).toUpperCase()}.${MATTER_SERVICE_QNAME}`;

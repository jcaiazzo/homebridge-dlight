...
import { Bytes, Channel, ChannelType, Duration, MaybePromise, Observable, ServerAddressIp, ServerAddressUdp } from "@matter/general";
export declare class MessageChannel implements Channel<Message> {
    ...
    get networkAddressChanged(): Observable<[ServerAddressIp], void>;

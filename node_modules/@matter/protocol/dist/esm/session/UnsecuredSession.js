...
import { ChannelType, Diagnostic, MatterFlowError } from "@matter/general";
...
class UnsecuredSession extends Session {
  ...
  get via() {
    const transport = !this.isClosed && this.channel.transportChannel.type !== ChannelType.UDP ? `(${this.channel.transportChannel.type})` : "";

...
import { AsyncObservable, Bytes, Channel, Duration, Lifetime, ObservableValue, Timestamp } from "@matter/general";
...
export declare abstract class Session {
     ...
     */
    initiateForceClose(context: PeerLossContext): Promise<void>;

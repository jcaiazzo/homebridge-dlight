...
export declare function SessionIntervals(intervals?: Partial<SessionIntervals>): SessionIntervals;
export declare namespace SessionIntervals {
    const defaults: SessionIntervals;
}
//# sourceMappingURL=SessionIntervals.d.ts.map
...
export declare class BtpCodec {
    ...
    static encodeBleAdvertisementData(discriminator: number, vendorId: number, productId: number, hasAdditionalAdvertisementData?: boolean, isExtendedAnnouncement?: boolean): Uint8Array<ArrayBufferLike>;

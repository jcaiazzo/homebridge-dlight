...
import { AsyncObservable, Bytes, Construction, Duration, MatterFlowError } from "@matter/general";
...
export declare abstract class FailsafeContext {
    ...
    get fabricIndex(): import("@matter/types").FabricIndex | undefined;
    ...
    getNextFabricIndex(): import("@matter/types").FabricIndex;
    ...
    closePaseSession(context: PeerLossContext): Promise<void>;

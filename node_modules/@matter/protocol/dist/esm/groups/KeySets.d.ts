 ...
 */
import { BasicSet, Bytes, Crypto, Timestamp } from "@matter/general";
import type { GroupKeyManagement } from "@matter/types/clusters/group-key-management";
export declare const GROUP_KEY_INFO: AllowSharedBufferSource;
export declare class KeySets<T extends OperationalKeySet> extends BasicSet<T> {
    ...
    asGroupKeySet(groupKeySetId: number): {
        ...
        epochKey0: AllowSharedBufferSource | null;
        epochStartTime0: number | bigint | null;
        epochKey1: AllowSharedBufferSource | null;
        epochStartTime1: number | bigint | null;
        epochKey2: AllowSharedBufferSource | null;
    ...
    sessionIdFromKey(crypto: Crypto, operationalGroupKey: Bytes): Promise<number>;
}

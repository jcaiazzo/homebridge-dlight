 ...
 */
import { Bytes, CertificateError, Diagnostic, PublicKey } from "@matter/general";
...
class Noc extends OperationalBase {
  ...
  async verify(crypto, root, ica) {
    ...
    if (Bytes.areEqual(authorityKeyIdentifier, root.cert.extensions.subjectKeyIdentifier)) {
      issuer = root;
    } else if (ica !== void 0 && Bytes.areEqual(authorityKeyIdentifier, ica.cert.extensions.subjectKeyIdentifier)) {
      issuer = ica;
    }
    if (issuer === void 0) {
      throw new CertificateError(

 ...
 */
export declare const EnergyEvseModeBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, EnergyEvseMode, typeof EnergyEvseMode, new () => {}, Uncapitalize<string>> & {
    readonly id: "energyEvseMode";
};

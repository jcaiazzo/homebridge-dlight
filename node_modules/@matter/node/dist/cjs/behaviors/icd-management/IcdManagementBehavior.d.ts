 ...
 */
export declare const IcdManagementBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, IcdManagement, typeof IcdManagement, new () => {}, Uncapitalize<string>> & {
    readonly id: "icdManagement";
};

 ...
 */
export declare const DishwasherModeBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, DishwasherMode, typeof DishwasherMode, new () => {}, Uncapitalize<string>> & {
    readonly id: "dishwasherMode";
};

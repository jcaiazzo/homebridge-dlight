 ...
 */
export declare const SoftwareDiagnosticsBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, SoftwareDiagnostics, typeof SoftwareDiagnostics, new () => {}, Uncapitalize<string>> & {
    readonly id: "softwareDiagnostics";
};

 ...
 */
export declare const UnitLocalizationBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, UnitLocalization, typeof UnitLocalization, new () => {}, Uncapitalize<string>> & {
    readonly id: "unitLocalization";
};

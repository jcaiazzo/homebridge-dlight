...
var import_scenes_management = require("@matter/types/clusters/scenes-management");
...
function constraintErrorWithSceneId(groupId2, sceneId) {
  const response = { status: import_types.Status.ConstraintError, groupId: groupId2, sceneId };
  (0, import_Supervision.Supervision)(response, "sceneId").constraint = false;
  return response;
}
...
const { commands } = import_scenes_management.ScenesManagement.schema;
...
const ScenesManagementSchema = import_scenes_management.ScenesManagement.schema.extend(
  void 0,
  addScene.extend(
    void 0,
  ...
  viewScene.extend(void 0, viewScene.fields.extend("SceneId", { constraint: "none" })),
  removeScene.extend(void 0, removeScene.fields.extend("SceneId", { constraint: "none" })),
  storeScene.extend(void 0, storeScene.fields.extend("SceneId", { constraint: "none" })),
  copyScene.extend(
    void 0,
...
const ScenesManagementBase = import_ScenesManagementBehavior.ScenesManagementBehavior.for(import_scenes_management.ScenesManagement, ScenesManagementSchema).with(
  import_scenes_management.ScenesManagement.Feature.SceneNames
);
  ...
  implementScenes(behavior, applyFunc) {
    ...
    for (const attribute of type.schema.conformant.attributes) {
      ...
      sceneClusterDetails.attributes.add({
        id: attributeId,
        name: attributeName,
        schema: (0, import_types.TlvOfModel)(attribute),
        type: attrType,

 ...
 */
export declare const AccessControlBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, AccessControl, typeof AccessControl, new () => {}, Uncapitalize<string>> & {
    readonly id: "accessControl";
};

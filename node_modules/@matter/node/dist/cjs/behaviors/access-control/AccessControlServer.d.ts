 ...
 */
import { AclEndpointContext, AclEntry, AclList, Fabric, IncomingSubjectDescriptor, MessageExchange } from "@matter/protocol";
import { ClusterId, FabricIndex, SubjectId } from "@matter/types";
import { AccessControl as AccessControlTypes } from "@matter/types/clusters/access-control";
declare const AccessControlServer_base: import("../../index.js").ClusterBehavior.Type<import("./AccessControlBehavior.js").AccessControlBehaviorConstructor, import("@matter/types").ClusterType.WithSupportedFeatures<AccessControlTypes, {
    extension: true;
    managedDevice: false;
}>, import("@matter/types").ClusterType.Concrete, new () => {}, "accessControl">;
/**

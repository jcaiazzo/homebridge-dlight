 ...
 */
export declare const PressureMeasurementBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, PressureMeasurement, typeof PressureMeasurement, new () => {}, Uncapitalize<string>> & {
    readonly id: "pressureMeasurement";
};

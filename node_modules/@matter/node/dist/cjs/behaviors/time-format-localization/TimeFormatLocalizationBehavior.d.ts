 ...
 */
export declare const TimeFormatLocalizationBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, TimeFormatLocalization, typeof TimeFormatLocalization, new () => {}, Uncapitalize<string>> & {
    readonly id: "timeFormatLocalization";
};

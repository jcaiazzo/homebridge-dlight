 ...
 */
export declare const OccupancySensingBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, OccupancySensing, typeof OccupancySensing, new () => {}, Uncapitalize<string>> & {
    readonly id: "occupancySensing";
};

 ...
 */
export declare const BooleanStateBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, BooleanState, typeof BooleanState, new () => {}, Uncapitalize<string>> & {
    readonly id: "booleanState";
};

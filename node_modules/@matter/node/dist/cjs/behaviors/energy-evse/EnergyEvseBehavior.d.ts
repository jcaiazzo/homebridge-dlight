 ...
 */
export declare const EnergyEvseBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, EnergyEvse, typeof EnergyEvse, new () => {}, Uncapitalize<string>> & {
    readonly id: "energyEvse";
};

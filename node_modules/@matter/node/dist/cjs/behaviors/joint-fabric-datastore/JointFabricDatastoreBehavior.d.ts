 ...
 */
export declare const JointFabricDatastoreBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, JointFabricDatastore, typeof JointFabricDatastore, new () => {}, Uncapitalize<string>> & {
    readonly id: "jointFabricDatastore";
};

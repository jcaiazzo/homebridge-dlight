...
function configureProperty(supervisor, schema) {
  ...
  const isFabricScopedList = schema.effectiveAccess.fabric === import_model.Access.Fabric.Scoped && schema.effectiveMetatype === import_model.Metatype.array;
  let defaultReader;
  ...
  if (manage === import_PrimitiveManager.PrimitiveManager) {
    ...
    descriptor.get = function() {
      ...
      const ref = new import_ManagedReference.ManagedReference(

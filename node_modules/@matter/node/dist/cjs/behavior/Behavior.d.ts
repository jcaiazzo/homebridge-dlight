...
import { type DeepPartial, EventEmitter, Lifetime, MaybePromise, Observable, Transaction } from "@matter/general";
...
export declare abstract class Behavior {
     ...
     */
    get env(): import("@matter/general").Environment;
    /**
     * The Behavior's type.
     */
     ...
     */
    protected callback<A extends any[], R>(reactor: Reactor<A, R>, options?: Reactor.Options): (...args: A) => R;
    /**
...
export declare namespace Behavior {
     ...
     */
    type PatchStateOf<B extends Type> = DeepPartial<StateOf<B>>;
    /**

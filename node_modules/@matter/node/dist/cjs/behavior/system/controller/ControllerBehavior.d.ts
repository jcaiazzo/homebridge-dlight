...
import { CommissionableMdnsScanner, FabricAuthorityConfiguration, PeerAddress } from "@matter/protocol";
...
export declare class ControllerBehavior extends Behavior {
    ...
    readonly state: ControllerBehavior.State;
    initialize(): Promise<void>;
    /**
     * Allocate a new node address in the given fabric.
     */
    allocatePeerAddress(fabricIndex: FabricIndex, nodeId?: NodeId): Promise<PeerAddress>;

...
((RemoteDescriptor2) => {
  ...
  function fromLongForm(long) {
    ...
    if (tcpSupport !== void 0) {
      result.T = import_protocol.SupportedTransportsSchema.decode(tcpSupport);
    }
    ...
    if (isOperational) {
      if (addresses !== void 0) {
        result.addresses = addresses?.filter((address) => import_general.ServerAddress.isIp(address)).map(import_general.ServerAddress);
      }
    } else {
      if (addresses !== void 0) {
  ...
  function toLongForm(descriptor, long = {}) {
    ...
    long.tcpSupport = T === void 0 ? void 0 : import_protocol.SupportedTransportsSchema.encode(T);

...
class ClientGroup extends import_ClientNode.ClientNode {
  #interaction;
  nodeType = "group";
  async get(_selector, _options) {
    throw new import_ClientGroupInteraction.InvalidGroupOperationError("Groups do not support reading attributes");
  }
  async getStateOf(_type, _selector, _options) {
    throw new import_ClientGroupInteraction.InvalidGroupOperationError("Groups do not support reading attributes");
  }
  get interaction() {

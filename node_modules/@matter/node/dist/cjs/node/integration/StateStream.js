    ...
    try {
      ...
      while (true) {
        ...
        while (queueHead) {
          ...
          let changes;
          if (state.dirty) {
            const allState = endpoint.stateOf(behavior);
            changes = {};
            for (const name of state.dirty) {
              changes[name] = (0, import_general.deepCopy)(allState[name]);
            }
            state.dirty = void 0;
          } else {
            changes = (0, import_general.deepCopy)(endpoint.stateOf(behavior));
          }
          yield {
            kind: "update",
            node: node2,

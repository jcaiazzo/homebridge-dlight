 ...
 */
export declare const FlowMeasurementBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, FlowMeasurement, typeof FlowMeasurement, new () => {}, Uncapitalize<string>> & {
    readonly id: "flowMeasurement";
};

 ...
 */
export declare const BooleanStateConfigurationBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, BooleanStateConfiguration, typeof BooleanStateConfiguration, new () => {}, Uncapitalize<string>> & {
    readonly id: "booleanStateConfiguration";
};

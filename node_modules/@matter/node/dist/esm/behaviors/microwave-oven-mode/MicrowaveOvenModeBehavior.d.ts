 ...
 */
export declare const MicrowaveOvenModeBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, MicrowaveOvenMode, typeof MicrowaveOvenMode, new () => {}, Uncapitalize<string>> & {
    readonly id: "microwaveOvenMode";
};

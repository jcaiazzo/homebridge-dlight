 ...
 */
export declare const WakeOnLanBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, WakeOnLan, typeof WakeOnLan, new () => {}, Uncapitalize<string>> & {
    readonly id: "wakeOnLan";
};

 ...
 */
export declare const AirQualityBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, AirQuality, typeof AirQuality, new () => {}, Uncapitalize<string>> & {
    readonly id: "airQuality";
};

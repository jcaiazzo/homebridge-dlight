 ...
 */
export declare const ZoneManagementBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, ZoneManagement, typeof ZoneManagement, new () => {}, Uncapitalize<string>> & {
    readonly id: "zoneManagement";
};
export interface ZoneManagementBehaviorConstructor extends Identity<typeof ZoneManagementBehaviorConstructor> {
}
export declare const ZoneManagementBehavior: ZoneManagementBehaviorConstructor;
export interface ZoneManagementBehavior extends InstanceType<ZoneManagementBehaviorConstructor> {
}
export declare namespace ZoneManagementBehavior {
    interface State extends InstanceType<typeof ZoneManagementBehavior.State> {
    }
}
//# sourceMappingURL=ZoneManagementBehavior.d.ts.map
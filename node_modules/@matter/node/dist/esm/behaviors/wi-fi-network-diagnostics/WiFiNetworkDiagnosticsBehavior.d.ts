 ...
 */
export declare const WiFiNetworkDiagnosticsBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, WiFiNetworkDiagnostics, typeof WiFiNetworkDiagnostics, new () => {}, Uncapitalize<string>> & {
    readonly id: "wiFiNetworkDiagnostics";
};

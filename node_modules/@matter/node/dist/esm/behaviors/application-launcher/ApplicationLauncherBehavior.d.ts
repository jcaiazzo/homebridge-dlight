 ...
 */
export declare const ApplicationLauncherBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, ApplicationLauncher, typeof ApplicationLauncher, new () => {}, Uncapitalize<string>> & {
    readonly id: "applicationLauncher";
};

 ...
 */
export declare const CommodityTariffBehaviorConstructor: ClusterBehavior.Type<typeof ClusterBehavior, CommodityTariff, typeof CommodityTariff, new () => {}, Uncapitalize<string>> & {
    readonly id: "commodityTariff";
};
export interface CommodityTariffBehaviorConstructor extends Identity<typeof CommodityTariffBehaviorConstructor> {
}
export declare const CommodityTariffBehavior: CommodityTariffBehaviorConstructor;
export interface CommodityTariffBehavior extends InstanceType<CommodityTariffBehaviorConstructor> {
}
export declare namespace CommodityTariffBehavior {
    interface State extends InstanceType<typeof CommodityTariffBehavior.State> {
    }
}
//# sourceMappingURL=CommodityTariffBehavior.d.ts.map
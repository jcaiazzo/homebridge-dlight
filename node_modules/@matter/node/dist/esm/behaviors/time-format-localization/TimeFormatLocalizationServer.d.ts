...
declare const TimeFormatLocalizationServer_base: import("../../index.js").ClusterBehavior.Type<import("./TimeFormatLocalizationBehavior.js").TimeFormatLocalizationBehaviorConstructor, import("@matter/types").ClusterType.WithSupportedFeatures<TimeFormatLocalization, {
    calendarFormat: true;
}>, import("@matter/types").ClusterType.Concrete, new () => {}, "timeFormatLocalization">;
/**

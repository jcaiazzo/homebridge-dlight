...
function astToFunction(schema, supervisor) {
  ...
  function compile(ast2) {
    switch (ast2?.type) {
      ...
      case Conformance.Special.Revision: {
        ...
        return revision >= ast2.param ? ConformantNode : NonconformantNode;
      }
  ...
  function createDotAccess({ lhs, rhs }) {
    ...
    if (compiledLhs.code === Code.Value) {
      ...
      return { code: Code.Value, value: lhsVal[propertyName] };
    }
    if (compiledLhs.code === Code.Evaluate) {
      ...
      return {
        ...
        evaluate: (value, options) => {
          ...
          if (lhsResult.code !== Code.Value || lhsResult.value === void 0 || lhsResult.value === null) {
            return { code: Code.Value, value: void 0 };
          }
          return { code: Code.Value, value: lhsResult.value[propertyName] };
        }
      };
    }
    return { code: Code.Value, value: void 0 };
  ...
  function createComparisonOp(operator, { lhs, rhs }) {
    ...
    try {
      if (lhs.type === Conformance.Special.Name) {
        ...
        const siblingScope = schema.parent instanceof ValueModel || schema.parent instanceof ClusterModel ? schema.parent : void 0;
